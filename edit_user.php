     ...
     <div class="panel panel-default">
       <div class="panel-heading">
        <strong>
          ...
          Update <?php echo remove_junk(ucwords($e_user['name'])); ?> Compte
        </strong>
       </div>
       <div class="panel-body">
          <form method="post" action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" class="clearfix">
            ...
            <div class="form-group clearfix">
                    <button type="submit" name="update" class="btn btn-info">Mise A Jour</button>
            </div>
        </form>
       </div>
     </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          Changer <?php echo remove_junk(ucwords($e_user['name'])); ?> Mot de passe
        </strong>
      </div>
      <div class="panel-body">
        <form action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
          ...
          <div class="form-group clearfix">
                  <button type="submit" name="update-pass" class="btn btn-danger pull-right">Modifier</button>
          </div>
        </form>
      </div>
    </div>
