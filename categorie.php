        ...
        <div class="panel-body">
          <form method="post" action="categorie.php">
            <div class="form-group">
                <input type="text" class="form-control" name="categorie-name" placeholder="Nom de la Categorie">
            </div>
            <button type="submit" name="add_cat" class="btn btn-primary">Ajouter une Categorie</button>
        </form>
        </div>
      </div>
    </div>
